const configApp = {
  ...
  BUNNY_STORAGE: {
    ...
    DEV:  { username: 'condaty-dev',  password: '04ccfd73-fc40-4312-bab429ed1d9b-886d-4509', hostname: 'br.storage.bunnycdn.com', port: 21, connectionType: 'Passive' as const, storageZoneName: 'condaty-dev',  apiKey: '04ccfd73-fc40-4312-bab429ed1d9b-886d-4509', cdnUrl: 'https://condaty-dev.bunnycdn.com' },
