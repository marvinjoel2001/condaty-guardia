const configApp = {
  ...
  BUNNY_STORAGE: {
    PROD: {
      username: 'prodcondaty',
      password: '3c6d2f24-2d75-42be-ad245cef6d45-f130-4a5e',
      hostname: 'br.storage.bunnycdn.com',
      port: 21,
      connectionType: 'Passive' as const,
      storageZoneName: 'prodcondaty',
      apiKey: '3c6d2f24-2d75-42be-ad245cef6d45-f130-4a5e',
      cdnUrl: 'https://condaty-prod.bunnycdn.com/',
    },
    DEV: {
      username: 'devcondaty',
      password: 'f7d671af-edaa-420a-a362a0208bc6-9975-4253',
      hostname: 'br.storage.bunnycdn.com',
      port: 21,
      connectionType: 'Passive' as const,
      storageZoneName: 'devcondaty',
      apiKey: 'f7d671af-edaa-420a-a362a0208bc6-9975-4253',
      cdnUrl: 'https://devcondaty.b-cdn.net/',
    },
    TEST: {
      username: 'testcondaty',
      password: '2e7c2dd2-988d-47ee-8c4bd7bea509-ad38-410e',
      hostname: 'br.storage.bunnycdn.com',
      port: 21,
      connectionType: 'Passive' as const,
      storageZoneName: 'testcondaty',
      apiKey: '2e7c2dd2-988d-47ee-8c4bd7bea509-ad38-410e',
