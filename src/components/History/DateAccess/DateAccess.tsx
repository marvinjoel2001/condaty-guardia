...
import {formatToDayDDMMYYYYHHMM} from '../../../../mk/utils/dates';
    ...
    <View style={styles.accessTimesContainer}>
      <View style={styles.timeRow}>
        ...
        <Text style={styles.timeText}>
          {formatToDayDDMMYYYYHHMM(access?.in_at) || 'No ha ingresado'}
        </Text>
      </View>
      <View style={styles.timeRow}>
        <Icon size={12} name={IconArrowLeft} color={cssVar.cError} />
        <Text style={styles.timeText}>
          {formatToDayDDMMYYYYHHMM(access?.out_at) || 'No ha salido'}
        </Text>
      </View>
    </View>
  );
