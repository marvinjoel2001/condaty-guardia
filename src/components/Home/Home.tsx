...
const Home = () => {
  ...
  // Función única y segura de ordenamiento (usada en todo el componente)
  ...
  const getAccesses = async (
    ...
    setData({ accesses: [], others: [], residents: [] });
    setLoaded(true);
    ...
    const sortedData = {
      accesses: sortByUpdatedAt(response?.data?.accesses ?? []),
      others: sortByUpdatedAt(response?.data?.others ?? []),
