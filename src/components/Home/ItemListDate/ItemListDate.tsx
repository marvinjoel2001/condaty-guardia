...
const ItemListDate = ({data1 = null, data2 = null, date = ""}: PropsType) => {
  return (
    <View
      ...
      <View style={{width: "86%"}}>
        {data1 && (
          <View style={styles.center}>
            ...
            />
            <Text style={styles.fecha}>{getDateTimeStrMes(data1)}</Text>
          </View>
        )}
        {data2 && (
          <View style={styles.center}>
            <Icon size={20} name={IconArrowLeft} color={cssVar.cError} />
            <Text style={styles.fecha}>{getDateTimeStrMes(data2)}</Text>
          </View>
        )}
      </View>
    </View>
